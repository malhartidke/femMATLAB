...
nodes = [2 0; 2 2; 0 2; 0 0];         %Defining the global co-ordinates of each node
...
boundary = [5 6 7 8];                 %Defining the Boundary Conditions on various nodes
...
disp('Displacment at A:')
disp('u = ')
disp(U(3))
disp('v = ')
disp(U(4))
disp('Displacement at B:')
disp('u = ')
disp(U(1))
disp('v = ')
disp(U(2))
disp('Reaction at point C:')
disp('Rx = ')
disp(Reaction(7))
disp('Ry = ')
disp(Reaction(8))
disp('Reaction at point D:')
disp('Rx = ')
disp(Reaction(5))
disp('Ry = ')
disp(Reaction(6))
